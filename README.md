This project provides a Python3 implementation of the CP-HMM method described in the manuscript:
...
The CP-HMM implementation uses an internal NumPy/SciPy log-space HMM backend and
